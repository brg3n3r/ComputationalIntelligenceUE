...
\begin{itemize}
    ...
    \item Multivariate Gaussian distributions\\        
        ...
        Omitting the exponential anchor the variance is still bigger than in scenario 2 although the single estimations are more even distributed around the mean value which is also very close to the real point. All in all the measurement is better witout the exponential anchor.
