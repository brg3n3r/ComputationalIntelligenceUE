...
def plot_poly(data, degree, theta_opt, n_line_precision=100):
    """
    Creates a plot that shows the polynomial expansion and the fit as compared to the scattered data sets.
    ...
    # Computation of the predicted model
...
def plot_errors(i_best, degrees, mse_train, mse_val, mse_test):
    """
    Displays the evolution of the error when the degree is increasing.
